...
resource "aws_iam_role_policy" "codebuild_kms_decrypt" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:kms:ap-south-1:247518864403:key/b3876fe5-d95c-4b32-87e9-3bea3d38b7a8" # You can restrict this to specific KMS key ARN
    }]
  })
}
...
resource "aws_iam_role_policy" "codepipeline_kms_decrypt" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:kms:ap-south-1:247518864403:key/b3876fe5-d95c-4b32-87e9-3bea3d38b7a8"
    }]
  })
}
